  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-neutral-100 font-serif selection:bg-[#D4AF37] selection:text-[#0A0A0A]">
      ...
      <div className="max-w-md mx-auto px-4 py-20">
        ...
        <div className="bg-gradient-to-b from-[#14110C] to-[#0A0A0A] border border-[#D4AF37]/40 rounded-lg p-8 shadow-2xl space-y-6 relative overflow-hidden">
          
          <div className="absolute -top-12 -right-12 w-40 h-40 bg-[#D4AF37]/10 blur-3xl rounded-full pointer-events-none" />
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs font-serif">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full bg-[#0A0A0A] border border-[#D4AF37]/30 px-3 py-2.5 text-neutral-100 focus:outline-none focus:border-[#D4AF37] rounded pl-9"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-[#0A0A0A] border border-[#D4AF37]/30 px-3.5 py-2.5 text-neutral-100 focus:outline-none focus:border-[#D4AF37] rounded pl-9 pr-9"
                ...
                <button 
                  ...
                  className="absolute right-3 top-3 text-neutral-400 hover:text-[#D4AF37]"
                >
            ...
            <div className="flex items-center justify-between text-[11px] text-neutral-400 pt-1">
              ...
              <span className="text-[#D4AF37] hover:underline cursor-pointer">Forgot password?</span>
            </div>

            <button
              type="submit"
              className="w-full py-3.5 bg-gradient-to-r from-[#F3E5AB] via-[#D4AF37] to-[#AA7C11] text-[#0A0A0A] font-serif text-xs font-bold uppercase tracking-widest rounded shadow-xl hover:opacity-95 transition-all flex items-center justify-center gap-2 mt-6"
          ...
          <div className="text-center pt-4 border-t border-neutral-800 text-xs font-serif">
            <span className="text-neutral-400">
              {isLogin ? "New to L'Élixir Noir?" : "Already a connoisseur?"}
            </span>{" "}
            <button
