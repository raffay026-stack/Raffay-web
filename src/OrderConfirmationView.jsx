...
export default function OrderConfirmationView() {
  ...
  const order = orders.find(o => o.id === id) || orders[0] || {
    ...
    shippingAddress: {
      ...
      address: "Nain sukh Al hamd garden house no 19 street no 9",
      city: "Lahore",
      postalCode: "10021",
      country: "Pakistan"
    },
        ...
        <div className="bg-[#12100C] border border-[#080809]/40 rounded-lg p-6 sm:p-10 shadow-2xl space-y-8 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-neutral-800">
            <button
              ...
              className="flex-1 py-3 bg-[#1C1610] border border-[#2FB59A]/40 text-[#9AE9D8] font-serif text-xs uppercase tracking-widest rounded hover:bg-[#282117] transition-all flex items-center justify-center gap-2"
            ...
            <button
              ...
              className="flex-1 py-3 bg-gradient-to-r from-[#2FB59A] to-[#2FB59A] text-[#9AE9D8] font-serif text-xs font-bold uppercase tracking-widest rounded shadow-lg hover:opacity-95 transition-all flex items-center justify-center gap-2"
            >
