          ...
          <div className="flex gap-2">
            {["all", "processing", "shipped", "delivered"].map((st) => (
              <button
                ...
                className={`px-4 py-2 rounded text-xs uppercase tracking-widest font-serif transition-all ${selectedStatus === st ? 'bg-[#2FB59A] text-[#9AE9D8] font-bold shadow-lg' : 'bg-[#12100C] text-neutral-400 border border-[#2FB59A]/30 hover:border-[#2FB59A]'}`}
              >
                {st}
              </button>
            ))}
        ...
        {filteredOrders.length === 0 ? (
          <div className="text-center py-24 bg-[#12100C] border border-[#080809]/20 rounded-lg space-y-4">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-gradient-to-r from-[#2FB59A] to-[#2FB59A] text-[#9AE9D8] font-serif text-xs font-bold uppercase tracking-widest rounded shadow"
            >
              Explore Collection
            </button>
          </div>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-4 border-b border-neutral-800 gap-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-[#1C1610] border border-[#2FB59A]/40 text-[#9AE9D8] font-serif text-xs uppercase tracking-wider rounded hover:bg-[#282117] transition-all flex items-center gap-1.5"
