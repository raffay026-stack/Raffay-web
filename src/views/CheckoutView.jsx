    ...
    return (
      <div className="min-h-screen bg-[#FFFDF8] text-[#2D2326] font-serif">
        ...
        <div className="max-w-4xl mx-auto px-4 py-32 text-center space-y-6">
          ...
          <p className="text-xs text-[#7C6E72]">Add luxury Perfumes to proceed to secure checkout.</p>
          <button
        ...
        <form onSubmit={handleSubmitOrder} className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="bg-[#FFFFFF] border border-[#43111F]/30 p-6 sm:p-8 rounded-lg space-y-6 shadow-xl">
              <div className="flex items-center justify-between border-b border-[#E5D8D0] pb-4">
                ...
                <span className="text-xs text-[#8A7A80] font-serif">Step 1 of 2</span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-serif">
                ...
                <div className="space-y-1.5 sm:col-span-2">
                  <label className="text-[#5D5054] uppercase tracking-wider">Email Address (For order tracking)</label>
                  <input 
                    type="email" 
                    name="email"
                    required
                ...
                <div className="space-y-1.5 sm:col-span-2">
                  <label className="text-[#5D5054] uppercase tracking-wider">Street Address & Suite</label>
                  <input 
                    type="text" 
                    name="address"
                    required
            ...
            <div className="bg-[#FFFFFF] border border-[#43111F]/30 p-6 sm:p-8 rounded-lg space-y-6 shadow-xl">
              <div className="flex items-center justify-between border-b border-[#E5D8D0] pb-4">
                ...
                <span className="text-xs text-[#8A7A80] font-serif">Step 2 of 2</span>
              </div>

              <div className="space-y-3 font-serif text-xs">
                <label className={`flex items-center gap-3 p-4 rounded border cursor-pointer transition-all ${formData.paymentMethod === 'credit-card' ? 'bg-[#F3E8E1] border-[#6E1F35]' : 'bg-[#FFFDF8] border-[#E5D8D0]'}`}>
                  <input 
                    type="radio" 
                    name="paymentMethod" 
                    value="credit-card"
                    ...
                    onChange={handleChange}
                    className="accent-[#43111F]"
                    data-testid={CHECKOUT.paymentMethodRadio}
                  />
                  <div className="flex items-center justify-between flex-1">
                    <span className="font-bold text-[#2D2326]">Credit / Debit Card (Simulated Secure)</span>
                    <CreditCard className="w-4 h-4 text-[#43111F]" />
                  </div>
                </label>

                <label className={`flex items-center gap-3 p-4 rounded border cursor-pointer transition-all ${formData.paymentMethod === 'online' ? 'bg-[#F3E8E1] border-[#6E1F35]' : 'bg-[#FFFDF8] border-[#E5D8D0]'}`}>
                  <input 
                    type="radio" 
                    name="paymentMethod" 
                    value="online"
                  ...
                  />
                  <div className="flex items-center justify-between flex-1">
                    <span className="font-bold text-[#2D2326]">Apple Pay / Google Pay Online</span>
                    <span className="text-[#43111F]">Instant</span>
                  </div>
                </label>

                <label className={`flex items-center gap-3 p-4 rounded border cursor-pointer transition-all ${formData.paymentMethod === 'cod' ? 'bg-[#F3E8E1] border-[#6E1F35]' : 'bg-[#FFFDF8] border-[#E5D8D0]'}`}>
                  <input 
                    type="radio" 
                    name="paymentMethod" 
                    value="cod"
                  ...
                  />
                  <div className="flex items-center justify-between flex-1">
                    <span className="font-bold text-[#2D2326]">Cash on Delivery (Courier Verification)</span>
                    <span className="text-[#7C6E72]">COD</span>
                  </div>
                </label>
              </div>

              {formData.paymentMethod === 'credit-card' && (
                <div className="space-y-4 pt-4 border-t border-[#E5D8D0] text-xs font-serif">
                  <div className="space-y-1.5">
                    <label className="text-[#5D5054] uppercase tracking-wider">Card Number</label>
                    <input 
                      type="text" 
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label className="text-[#5D5054] uppercase tracking-wider">Expiration Date</label>
                      <input 
                        type="text" 
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[#5D5054] uppercase tracking-wider">CVC Security Code</label>
                      <input 
                        type="text" 
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-[#FFFFFF] border border-[#43111F]/40 p-6 sm:p-8 rounded-lg shadow-2xl space-y-6 sticky top-28">
              ...
              <h3 className="text-lg font-serif font-bold text-[#43111F] border-b border-[#E5D8D0] pb-4">
              ...
              <div className="flex items-center justify-center gap-2 text-[10px] text-[#8A7A80] font-serif pt-2">
