  ...
  return (
    <div className="min-h-screen bg-[#FFFDF8] text-[#2D2326] font-serif selection:bg-[#43111F] selection:text-[#FFFDF8]">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        {/* Receipt Card */}
        <div className="bg-[#FFFFFF] border border-[#43111F]/40 rounded-lg p-6 sm:p-10 shadow-2xl space-y-8 relative overflow-hidden">
          
          <div className="absolute -top-12 -right-12 w-48 h-48 bg-[#43111F]/5 blur-3xl rounded-full pointer-events-none" />
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-6 border-b border-[#E5D8D0] gap-4">
            ...
            <div>
              ...
              <span className="text-sm text-[#2D2326]">{order.date}</span>
            </div>
            <div>
              <span className="text-[10px] text-[#8A7A80] uppercase tracking-widest block">Status</span>
              <span className="text-xs px-2.5 py-1 rounded bg-[#43111F]/20 text-[#43111F] border border-[#43111F]/40 inline-flex items-center gap-1 font-bold">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-xs font-serif pb-6 border-b border-[#E5D8D0]">
            <div className="space-y-2">
              <span className="text-[#43111F] uppercase tracking-wider font-bold block flex items-center gap-1.5">
                <Truck className="w-4 h-4" />
                <span>Shipping Destination</span>
              </span>
              <div className="text-[#5D5054] space-y-0.5">
                <div className="font-bold text-[#2D2326]">{order.shippingAddress?.fullName}</div>
          ...
          {/* Actions */}
          <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-[#E5D8D0]">
            <button
              onClick={() => window.print()}
              className="flex-1 py-3 bg-[#F7F1EC] border border-[#43111F]/40 text-[#43111F] font-serif text-xs uppercase tracking-widest rounded hover:bg-[#EFE5D8] transition-all flex items-center justify-center gap-2"
            ...
            <button
              ...
              className="flex-1 py-3 bg-gradient-to-r from-[#43111F] to-[#87344D] text-[#FFFDF8] font-serif text-xs font-bold uppercase tracking-widest rounded shadow-lg hover:opacity-95 transition-all flex items-center justify-center gap-2"
            >
